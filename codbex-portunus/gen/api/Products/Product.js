...
const dao = require("codbex-portunus/gen/dao/Products/Product");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-portunus/gen/api/Product.js/" + entity.Id);
