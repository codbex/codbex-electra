...
const dao = require("codbex-portunus/gen/dao/Products/ProductAttribute");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-portunus/gen/api/ProductAttribute.js/" + entity.Id);
