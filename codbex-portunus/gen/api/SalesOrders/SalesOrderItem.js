...
const dao = require("codbex-portunus/gen/dao/SalesOrders/SalesOrderItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-portunus/gen/api/SalesOrderItem.js/" + entity.Id);
