...
const dao = require("new-portunus/gen/dao/SalesOrders/SalesOrder");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/new-portunus/gen/api/SalesOrder.js/" + entity.Id);
