...
const dao = require("codbex-portunus/gen/dao/SalesOrders/SalesOrder");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-portunus/gen/api/SalesOrder.js/" + entity.Id);
