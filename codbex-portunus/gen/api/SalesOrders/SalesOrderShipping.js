...
const dao = require("new-portunus/gen/dao/SalesOrders/SalesOrderShipping");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/new-portunus/gen/api/SalesOrderShipping.js/" + entity.Id);
