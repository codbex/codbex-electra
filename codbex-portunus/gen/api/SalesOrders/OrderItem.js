...
const dao = require("new-portunus/gen/dao/SalesOrders/OrderItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/new-portunus/gen/api/OrderItem.js/" + entity.Id);
