...
const dao = require("new-portunus/gen/dao/UserGroups/EmployeeGroup");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/new-portunus/gen/api/EmployeeGroup.js/" + entity.Id);
