...
const dao = require("new-portunus/gen/dao/Settings/CustomerStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/new-portunus/gen/api/CustomerStatus.js/" + entity.Id);
