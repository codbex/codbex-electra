...
const dao = require("codbex-portunus/gen/dao/Settings/OrderStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-portunus/gen/api/OrderStatus.js/" + entity.Id);
