...
const dao = require("new-portunus/gen/dao/Settings/OrderStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/new-portunus/gen/api/OrderStatus.js/" + entity.Id);
