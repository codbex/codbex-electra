...
const dao = require("new-portunus/gen/dao/Settings/ZoneStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/new-portunus/gen/api/ZoneStatus.js/" + entity.Id);
