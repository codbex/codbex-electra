...
const dao = require("new-portunus/gen/dao/Settings/CountryStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/new-portunus/gen/api/CountryStatus.js/" + entity.Id);
