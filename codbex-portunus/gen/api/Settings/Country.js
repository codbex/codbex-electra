...
const dao = require("codbex-portunus/gen/dao/Settings/Country");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-portunus/gen/api/Country.js/" + entity.Id);
