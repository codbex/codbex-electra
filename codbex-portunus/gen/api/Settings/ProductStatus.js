...
const dao = require("new-portunus/gen/dao/Settings/ProductStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/new-portunus/gen/api/ProductStatus.js/" + entity.Id);
