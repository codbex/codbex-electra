...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("new-portunus/Settings/CustomerStatus");
	try {
	...
	producer.queue("new-portunus/Settings/CustomerStatus").send(JSON.stringify(data));
}