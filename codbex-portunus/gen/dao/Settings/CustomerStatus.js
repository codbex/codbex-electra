...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("codbex-portunus/Settings/CustomerStatus");
	try {
	...
	producer.queue("codbex-portunus/Settings/CustomerStatus").send(JSON.stringify(data));
}