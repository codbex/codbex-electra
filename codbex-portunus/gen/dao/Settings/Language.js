...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("codbex-portunus/Settings/Language");
	try {
	...
	producer.queue("codbex-portunus/Settings/Language").send(JSON.stringify(data));
}