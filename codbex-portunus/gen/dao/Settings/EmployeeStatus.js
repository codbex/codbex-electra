...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("new-portunus/Settings/EmployeeStatus");
	try {
	...
	producer.queue("new-portunus/Settings/EmployeeStatus").send(JSON.stringify(data));
}