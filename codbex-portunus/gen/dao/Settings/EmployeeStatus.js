...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("codbex-portunus/Settings/EmployeeStatus");
	try {
	...
	producer.queue("codbex-portunus/Settings/EmployeeStatus").send(JSON.stringify(data));
}