...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("codbex-portunus/Customer/Affiliate");
	try {
	...
	producer.queue("codbex-portunus/Customer/Affiliate").send(JSON.stringify(data));
}