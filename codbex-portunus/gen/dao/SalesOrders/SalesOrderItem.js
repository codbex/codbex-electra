...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("codbex-portunus/SalesOrders/SalesOrderItem");
	try {
	...
	producer.queue("codbex-portunus/SalesOrders/SalesOrderItem").send(JSON.stringify(data));
}