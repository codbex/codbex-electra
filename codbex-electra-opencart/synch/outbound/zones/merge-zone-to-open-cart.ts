...
class MergeZoneToOpenCart extends BaseHandler {
    ...
    handle() {
        ...
        const zoneReference = this.entityReferenceDAO.getZoneReferenceByEntityId(storeId, zoneId);
    ...
    private createOpenCartZone(zoneReference: EntityReferenceEntity | null): oc_zoneCreateEntity | oc_zoneUpdateEntity {
        ...
        const countryId = this.entityReferenceDAO.getRequiredCountryReferenceByEntityId(this.zoneEntry.store.id, zone.Country).ReferenceIntegerId!;
