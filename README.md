...
|--|--|--|
| DIRIGIBLE_HOME_URL | Electra home URL | /services/web/codbex-electra/index.html |
...
- After a few seconds, the Electra should be available on the following path `/services/web/codbex-electra/index.html`. If the Dirigible is hosted on `localhost`, the URL will be  [http://localhost:8080/services/web/codbex-electra/index.html](http://localhost:8080/services/web/codbex-electra/index.html)
