...
import { LanguageRepository, LanguageEntityOptions } from "../../dao/Languages/LanguageRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-electra-Languages-Language", ["validate"]);
...
class LanguageService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-electra/gen/api/Languages/LanguageService.ts/" + entity.Id);
