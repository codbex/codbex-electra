...
const dao = require("codbex-electra/gen/dao/SalesOrders/SalesOrder");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-electra/gen/api/SalesOrder.js/" + entity.Id);
