...
const dao = require("codbex-electra/gen/dao/SalesOrders/SalesOrderShipping");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-electra/gen/api/SalesOrderShipping.js/" + entity.Id);
