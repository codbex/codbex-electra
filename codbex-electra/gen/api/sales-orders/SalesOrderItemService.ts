...
import { SalesOrderItemRepository, SalesOrderItemEntityOptions } from "../../dao/sales-orders/SalesOrderItemRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-electra-sales-orders-SalesOrderItem", ["validate"]);
...
class SalesOrderItemService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-electra/gen/api/sales-orders/SalesOrderItemService.ts/" + entity.Id);
