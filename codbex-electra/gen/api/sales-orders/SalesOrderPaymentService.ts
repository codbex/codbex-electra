...
import { SalesOrderPaymentRepository, SalesOrderPaymentEntityOptions } from "../../dao/sales-orders/SalesOrderPaymentRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-electra-sales-orders-SalesOrderPayment", ["validate"]);
...
class SalesOrderPaymentService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-electra/gen/api/sales-orders/SalesOrderPaymentService.ts/" + entity.Id);
