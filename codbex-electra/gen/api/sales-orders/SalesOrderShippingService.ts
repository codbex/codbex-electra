...
import { SalesOrderShippingRepository, SalesOrderShippingEntityOptions } from "../../dao/sales-orders/SalesOrderShippingRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-electra-sales-orders-SalesOrderShipping", ["validate"]);
...
class SalesOrderShippingService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-electra/gen/api/sales-orders/SalesOrderShippingService.ts/" + entity.Id);
