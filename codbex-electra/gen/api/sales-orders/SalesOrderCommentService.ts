...
import { SalesOrderCommentRepository, SalesOrderCommentEntityOptions } from "../../dao/sales-orders/SalesOrderCommentRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-electra-sales-orders-SalesOrderComment", ["validate"]);
...
class SalesOrderCommentService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-electra/gen/api/sales-orders/SalesOrderCommentService.ts/" + entity.Id);
