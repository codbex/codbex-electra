...
import { AttributeGroupTranslationRepository, AttributeGroupTranslationEntityOptions } from "../../dao/Attribute groups/AttributeGroupTranslationRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-electra-Attribute groups-AttributeGroupTranslation", ["validate"]);
...
class AttributeGroupTranslationService {
    ...
    public getAll(_: any, ctx: any) {
        try {
            let AttributeGroup = parseInt(ctx.queryParameters.AttributeGroup);
            AttributeGroup = isNaN(AttributeGroup) ? ctx.queryParameters.AttributeGroup : AttributeGroup;
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-electra/gen/api/Attribute groups/AttributeGroupTranslationService.ts/" + entity.Id);
