...
const dao = require("codbex-electra/gen/dao/Settings/LanguageStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-electra/gen/api/LanguageStatus.js/" + entity.Id);
