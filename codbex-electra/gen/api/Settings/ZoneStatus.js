...
const dao = require("codbex-electra/gen/dao/Settings/ZoneStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-electra/gen/api/ZoneStatus.js/" + entity.Id);
