...
const dao = require("codbex-electra/gen/dao/Settings/CurrencyStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-electra/gen/api/CurrencyStatus.js/" + entity.Id);
