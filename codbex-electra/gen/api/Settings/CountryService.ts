...
const validationModules = await Extensions.loadExtensionModules("codbex-electra-Settings-Country", ["validate"]);
...
class CountryService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-electra/gen/api/Settings/CountryService.ts/" + entity.Id);
