...
const dao = require("codbex-electra/gen/dao/Settings/EmployeeStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-electra/gen/api/EmployeeStatus.js/" + entity.Id);
