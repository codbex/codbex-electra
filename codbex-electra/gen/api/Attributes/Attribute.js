...
const dao = require("codbex-electra/gen/dao/Attributes/Attribute");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-electra/gen/api/Attribute.js/" + entity.Id);
