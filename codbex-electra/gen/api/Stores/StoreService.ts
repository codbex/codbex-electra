...
const validationModules = await Extensions.loadExtensionModules("codbex-electra-Stores-Store", ["validate"]);
...
class StoreService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-electra/gen/api/Stores/StoreService.ts/" + entity.Id);
    ...
    private validateEntity(entity: any): void {
        ...
        if (entity.Url?.length > 255) {
            throw new ValidationError(`The 'Url' exceeds the maximum length of [255] characters`);
        }
