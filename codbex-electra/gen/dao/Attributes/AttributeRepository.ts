...
export class AttributeRepository {
    ...
    private async triggerEvent(data: AttributeEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-electra-Attributes-Attribute", ["trigger"]);
        ...
        producer.topic("codbex-electra-Attributes-Attribute").send(JSON.stringify(data));
    }
}
