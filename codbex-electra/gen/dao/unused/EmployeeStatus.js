...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("codbex-electra/unused/EmployeeStatus");
	try {
	...
	producer.queue("codbex-electra/unused/EmployeeStatus").send(JSON.stringify(data));
}