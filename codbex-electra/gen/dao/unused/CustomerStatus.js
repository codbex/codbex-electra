...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("codbex-electra/unused/CustomerStatus");
	try {
	...
	producer.queue("codbex-electra/unused/CustomerStatus").send(JSON.stringify(data));
}