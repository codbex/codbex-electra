...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("codbex-electra/Manufacturers/Manufacturer");
	try {
	...
	producer.queue("codbex-electra/Manufacturers/Manufacturer").send(JSON.stringify(data));
}