...
function triggerEvent(data) {
	let triggerExtensions = extensions.getExtensions("codbex-electra/Customer/Customer");
	try {
	...
	producer.queue("codbex-electra/Customer/Customer").send(JSON.stringify(data));
}