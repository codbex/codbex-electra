...
export class StoreConfigurationRepository {
    ...
    public count(Store: number): number {
        const resultSet = query.execute('SELECT COUNT(*) AS COUNT FROM "CODBEX_STORECONFIGURATION" WHERE "STORECONFIGURATION_STORE" = ?', [Store]);
