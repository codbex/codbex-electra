...
export class AttributeGroupTranslationRepository {
    ...
    public count(options?: AttributeGroupTranslationEntityOptions): number {
    ...
    private async triggerEvent(data: AttributeGroupTranslationEntityEvent) {
        ...
        producer.topic("codbex-electra-attribute-groups-AttributeGroupTranslation").send(JSON.stringify(data));
    }
}
